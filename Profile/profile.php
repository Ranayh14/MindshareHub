...
<body>
    ...
    <div class="bg-customBody flex-1 flex flex-col ml-64">
            ...
            <header class="bg-customMain p-4 flex items-center justify-between mr-8 ml-4 mt-4">
                ...
                <a href="#" class="mb-20 mt-4 mr-4"><i class="fi fi-ss-settings"></i></a>
            </header>

            <!-- Tabs -->
            <nav class="bg-customMain text-gray-400 flex justify-center border-b border-gray-700 space-x-12 mr-8 ml-4">
                <a href="#" class="px-4 py-2 hover:text-white border-b-2 border-transparent hover:border-white">Posts</a>
                <a href="#" class="px-4 py-2 hover:text-white border-b-2 border-transparent hover:border-white">Replies</a>
                <a href="#" class="px-4 py-2 hover:text-white border-b-2 border-transparent hover:border-white">Likes</a>
            </nav>
            ...
            <main class="flex-1 p-4 space-y-4">
                <div class="post p-4 rounded-lg mr-4">
                    ...
                    <div class="flex items-center text-gray-400">
                        ...
                        <i class="fas fa-share ml-4 mr-2"></i> 50
                    </div>
                </div>
                <div class="post p-4 rounded-lg mr-4">
                    <div class="flex items-center">
                ...
                </div><div class="post p-4 rounded-lg mr-4">
                    <div class="flex items-center">
                        <img alt="User profile picture" class="rounded-full mr-2" height="40" src="https://storage.googleapis.com/a1aa/image/vpFbuBQSu6LwNJADhiVP5b1OuoExmfWPdjHPBfqWjWA3zL6TA.jpg" width="40">
                        <div>
                            <div class="flex items-center">
